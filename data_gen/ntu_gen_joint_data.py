...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='../raw_skeleton_data/nturgbd_skeletons_s001_to_s017/nturgb+d_skeletons')
    parser.add_argument('--ignored_sample_path',
                        default='../raw_skeleton_data/samples_with_missing_skeletons.txt')
